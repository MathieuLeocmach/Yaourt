...
\begin{figure}
	...
	\nextgroupplot[ylabel={Relative volume}, ymin=0.3, ymax=1, extra x ticks={12.55}]
	\addplot+[no marks,Accent1] table{volume_rel_half_cas8.txt};
	\node[rotate=90, anchor=base] at (axis cs:12.55,0.75) (syn) {synæresis};
	\node[right=0 of syn.south west] {swelling};
	
	\nextgroupplot[ylabel={Excess area (\%)}, ymin=0, ymax=1.2, extra x ticks={26.7, 42.8}]
	...
	\end{tikzpicture}
	\caption{Syneresis and swelling (c) Evolution of the volume of the gel phase. (d) Evolution of the midsurface area.}
	\label{fig:wrinkles}
\end{figure}
