...
\begin{figure}
	...
	\begin{scope}[->,gray,ultra thick]
		\draw (m-2-1.east) -- (m-7-1.east) -- (m-2-2.west) -- (m-7-2.west);
	\end{scope}
	
	%\node[inner sep=0, anchor=south east] (g-1-1.outer north west){\includegraphics[width=0.45\columnwidth]{plastic_confocal}};
	\end{tikzpicture}
	\caption{Synæresis and swelling (c) Evolution of the volume of the gel phase. (d) Evolution of the midsurface area.}
	\label{fig:wrinkles}
\end{figure}
