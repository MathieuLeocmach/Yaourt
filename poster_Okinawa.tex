...
\LHead{\textsc{Laboratoire de Physique, Ecole Normale Supérieure de Lyon}\hfill\raisebox{-1.5\baselineskip}{\includegraphics[height=2\baselineskip,clip=true, trim=0 10mm 0 0]{NEW-Logo-ERC-OUTLINE}\qquad\includegraphics[height=2\baselineskip]{CNRSfilaire-Q}\qquad\includegraphics[height=2\baselineskip]{logo_ens-lyon}}}
