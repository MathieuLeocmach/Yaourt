...
\titlegraphic{
	\begin{tabu}{X[c]X[c]X[c]}
		...
		Christophe\linebreak Perge & Thibaut\linebreak Divoux & Sebastien Manneville\\
	\end{tabu}
...
\end{center}
\vspace{6\baselineskip}
\textit{\footnotesize Leocmach, Perge, Divoux \& Manneville. Creep and fracture of a protein gel under stress. Phys Rev Lett. 2014;113(3):038303.}
\end{frame}
