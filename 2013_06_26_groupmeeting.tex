...
\column{0.4\textwidth}
cas 2\% GDL 1\%\\
\includegraphics[width=\textwidth]{motif_cas2_GDL1_zoom1.png}

\bigskip

cas 2\% GDL 2\%\\
\includegraphics[width=\textwidth]{motif_cas3_GDL2_zoom1.png}
\end{columns}
...
\column{0.5\textwidth}
4\% 1\%\\
\includegraphics[width=0.8\textwidth]{motif_cas4_GDL1.png}
\begin{itemize}
