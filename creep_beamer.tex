...
\item \begin{minipage}{0.4\textwidth}\center reversible,\\ homogeneous creep\end{minipage} \hfill\textcolor{ilmorange}{$\rightarrow$}\hfill \begin{minipage}{0.4\textwidth}\center irreversible fracture growth\end{minipage}
