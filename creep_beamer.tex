...
\end{loglogaxis}
\end{tikzpicture}
\[ \sigma \propto  \gamma f^\alpha \xrightarrow{\mathrm{Fourier}} \sigma \propto \gamma t^{-\alpha} \]
Constant $\sigma$
\[ \gamma(t) \propto \sigma t^{\alpha} \xrightarrow{\frac{d}{dt}} \dot\gamma(t) \propto \sigma t^{\alpha-1}\]
