...
\begin{figure}
	...
	\caption{Acid-induced protein gel properties behave non monotonically with pH. (a) pH decrease over time in a 4\%w sodium caseinate solution acidified by 4\%w GDL. The horizontal line indicates isoelectric pH of caseins. (b) Evolution of the storage modulus $G'$ measured in a rheometer with full adhesion to rotor and stator. (c) Evolution of pore size measured by confocal microscopy in a slit geometry with either adhesion to all walls (black line) or no adhesion to top wall, i.e. allowed syn\ae{}resis and swelling (orange dashed line).}%
	\label{fig:acidification}%
\end{figure}


To form wrinkled patterns such as the one oberved in figure 1XXX, ones needs to take advantage of the pH sensitivity of caseins to control the route to gelation, to fine tune the gel properties and the boundary conditions.

The stability of caseins dispersion strongly depend on the pH of the solution. Supplementary movie 3XXX shows the titration of a caseins dispersion at 1\%w by 1 molar HCl. At pH=7, the caseins are well dispersed then then flocculate between pH= XXX to XXX and finaly at pH=XXX the solution become clear again. However as one increases the caseins concentration up to 4\%w, at low pH the caseins redispersion is not total, Supplementary movie 4XXX. The state diagram of caseins as a function of the pH  is related to charge stabilization. At neutral pH caseins are charged negatively and repel each other. As the pH decreases to the isoelectric point of the caseins (pH=4.5), caseins molecules loose their negative net charge and tend to stick to each other [ref XXX casein stability]. Beyond the isoelectric point casein acquire a positive net charge and therefore partially re-dissolve. In figure 2cXXX, we quantify this effect and measure with UV absorption spectroscopy the amount of free caseins within the 4\%w dispersion as a function of pH (see Supplementary Methods). Starting at pH=6.8 all the casein molecules are well dispersed and the free casein fraction is 1. Upon decreasing the pH of the solution to the isolectric point the free casein fraction drop to almost 0, almost all the casein molecule are aggregated. Further decrease of the pH of the solution lead to a partial redissolution of the casein aggregates. At pH=2 the fraction of free casein is XXX.

%On the Stability of Casein Micelles, Pieter Walstra J. of dairy science 1990

To form a space spanning gel, flocculation need to be prevented. We use of Glucono-$\delta$-lactone (GDL) a molecule  that slowly hydrolyses into an acid and thus lowers slowly, continuously and homogeneously the pH of the medium, fig.2aXXX. This GDL controlled acidification permits the formation of a bulk gel phase. We monitor the GDL induced gelation with a rheometer in cone plate geometry. As casein strongly adsorbs to surfaces, the strain and stress are well transmitted to the casein dispersion and we can measure the elastic and viscous modulus of the casein dispersion as a function of time. the mechanical properties of the gel are closely related to the fraction of free casein. First, the dispersion solidifies then reaches its maximum elasticity (500 Pa) at the isoelectric point and finally the elastic modulus decreases down to 100 Pa.

To gain further insight into the mechanical properties of the gel we turn to micro structural observations under confocal microscopy. As shown in supplementary fig. 1XXX the gel consist in a space spanning fractal network with a cut off length scale xi. xi corresponds to the maximum pore size of the network. This model fits the structure at all times but its parameters vary non monotonously during GDL acidification. As shown in Fig. 2cXXX, up to the isolectric point xi increases up to a maximum length of 7 $\mu$m due to the solvent expulsion out of the casein network [refXXX]. This stiffen the arm of the network and is responsible for the increase of elasticity. Beyond the isoelectric point xi decreases down to 4$\mu$m. Casein regain solubility [refXXX], the strand network swell, the pore shrinks and the gel weakens.

As seen on the confocal measurements, the gel is porous and is permeable to the solvent.  This property is determinant as it allow the gel to absorb and expel the solvent and therefore change its volume when sticky boundary are turned off. To quantify this effect, we have embedded the casein gel inside a capillary and dip vertically the capillary in an aqueous buffer [refXXX]. In the supplementary figure XXX, we observe that the aqueous buffer goes through the gel and rise in the tube due to capillary forces. Exploitation of this experiment give the permeability of the gel: 67000 nm$^2$.

Boundary conditions is the final parameter that is essential to form wrinkled patterns. The evolution of xi when sticky boundaries are on reflects the inner constrains of the gel:  xi increases, the stand of the network become thinner and the gel wants to retract; then xi decreases, the stands of network swell and the gel wants to expend. When the casein adhesion to the upper boundary is turned off, the gel still not wrinkles because it remains attached to the bottom wall, but it detach from the top wall. In this situation we can monitor xi, fig. XXX. xi remains mostly constant and the major effect is reported on the volume occupied by the gel as will be reported below.
